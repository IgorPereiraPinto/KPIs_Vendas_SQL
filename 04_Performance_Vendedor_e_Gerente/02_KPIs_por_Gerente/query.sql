/*
  ...
  Análise: KPIs por Gerente
  Objetivo:
    Consolidar desempenho por gerente com KPIs principais.
  Perguntas respondidas:
    - Qual gerente gera mais receita e margem?
  Definições de KPIs:
...
cte_kpis AS (
    SELECT
        ...
        END AS Ticket_Medio
    FROM cte_base
    GROUP BY Ano, Mes, Categoria, Produto, Gerente
),
cte_rank AS (
    SELECT
        *,
