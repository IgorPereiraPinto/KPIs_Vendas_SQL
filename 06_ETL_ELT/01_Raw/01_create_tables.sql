/*
  ...
  Script: 01_create_tables.sql (Raw)
  Objetivo:
    Criar tabelas RAW espelhando a origem com colunas técnicas mínimas.
  Entradas:
    Arquivos/extrações brutas das fontes.
  Saídas:
    Tabelas dbo.raw_* com metadados de carga.
*/
