/*
  ...
  Análise: Performance por Cidade e Estado
  Objetivo:
    Identificar melhores e piores cidades/estados em receita, margem e ticket.
  Perguntas respondidas:
    - Quais cidades/estados performam melhor?
  Definições de KPIs:
...
cte_kpis AS (
    SELECT
        ...
        END AS Ticket_Medio
    FROM cte_base
    GROUP BY Ano, Mes, Categoria, Produto, Cidade, Estado
),
cte_rank AS (
    SELECT
        *,
